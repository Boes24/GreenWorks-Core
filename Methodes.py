import requests
from different_objects import login_object
from different_objects import user_info_object
from different_objects import mower_info_object

class Methodes:
    """
    This class contains methods to interact with the GreenWorks API.
    It includes methods for user login and retrieving user information.
    """

    def __init__(self):
        """Initialize the Methodes class."""
        # Base URL for the API
        self.base_url = "https://xapi.globetools.systems/v2"
